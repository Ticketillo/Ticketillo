...
interface TicketInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: "soldOut", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "soldOut", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "supportsInterface",
    data: BytesLike
  ): Result;
...
export class Ticket extends BaseContract {
  ...
  functions: {
    ...
    soldOut(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    soldOut(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    soldOut(overrides?: CallOverrides): Promise<PopulatedTransaction>;
